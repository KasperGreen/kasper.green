...
* Познал легаси в виде движка основанного на phpBB2, на мне последующая его доработка новых и оптимизация старых.<br />
* В силу не коммерческой основы ресурса остро стояла задача вписаться в один не слишком производительный сервер.<br />
